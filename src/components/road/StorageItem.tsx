...
type StorageNames = ["barrel", "barrel-open", "box", "box-open", "box-large", "box-large-open"]

type ModelProps = {
    name: StorageNames[number]
    rotation?: Tuple3
    position: Tuple3
}
...
export default function StorageItem({
    ...
    const { nodes } = useGLTF(model) as unknown as GLTFModel<StorageNames>
