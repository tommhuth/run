...
export default function CannonDebugRenderer(scene, world, options) {
    ...
    this._sphereGeometry = new THREE.SphereGeometry(1, 8, 8);
    this._boxGeometry = new THREE.BoxGeometry(1, 1, 1);
    this._planeGeometry = new THREE.PlaneGeometry(1000, 1000, 10, 1);
    this._cylinderGeometry = new THREE.CylinderGeometry(1, 1, 10, 16);
};
